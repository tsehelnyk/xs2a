...
public class PaymentServiceMock {
    ...
    public SpiResponse<SpiPaymentConfirmationCodeValidationResponse> notifyConfirmationCodeValidation(boolean confirmationCodeValidationResult, SpiPayment payment, boolean isCancellation) {
        ...
        Xs2aTransactionStatus transactionStatus = isCancellation
    ...
    private Xs2aTransactionStatus getCancellationTransactionStatus(boolean confirmationCodeValidationResult, SpiPayment payment) {
        return confirmationCodeValidationResult ? Xs2aTransactionStatus.CANC : payment.getPaymentStatus();
    }

    private Xs2aTransactionStatus getTransactionStatus(boolean confirmationCodeValidationResult) {
        return confirmationCodeValidationResult ? Xs2aTransactionStatus.ACSP : Xs2aTransactionStatus.RJCT;
    }
}

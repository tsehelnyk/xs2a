...
class AuthorisationStageCheckValidatorTest {
    ...
    private static final Xs2aScaStatus RECEIVED_STATUS = Xs2aScaStatus.RECEIVED;
    private static final Xs2aScaStatus PSUIDENTIFIED_STATUS = Xs2aScaStatus.PSUIDENTIFIED;
    private static final Xs2aScaStatus PSUAUTHENTICATED_STATUS = Xs2aScaStatus.PSUAUTHENTICATED;
    private static final Xs2aScaStatus SCAMETHODSELECTED_STATUS = Xs2aScaStatus.SCAMETHODSELECTED;
    private static final Xs2aScaStatus FINALISED_STATUS = Xs2aScaStatus.FINALISED;
    private static final Xs2aScaStatus EXEMPTED_STATUS = Xs2aScaStatus.EXEMPTED;

...
class MultiReadHttpServletRequestMultiReadHttpServletRequestMultiReadHttpServletRequestMultiReadHttpServletRequestMultiReadHttpServletRequestMultiReadHttpServletRequestMultiReadHttpServletRequestUpdatePiisConsentLinksImplTest {
    ...
    void isScaStatusMethodAuthenticated() {
        ...
        expectedLinks.setScaStatus(new Xs2aHrefType("http://url/v2/consents/confirmation-of-funds/9mp1PaotpXSToNCiu4GLwd6mq/authorisations/463318a0-1e33-45d8-8209-e16444b18dda"));
        expectedLinks.setSelectAuthenticationMethod(new Xs2aHrefType("http://url/v2/consents/confirmation-of-funds/9mp1PaotpXSToNCiu4GLwd6mq/authorisations/463318a0-1e33-45d8-8209-e16444b18dda"));
    ...
    void isScaStatusMethodSelectedAndRedirectApproach() {
        ...
        expectedLinks.setScaStatus(new Xs2aHrefType("http://url/v2/consents/confirmation-of-funds/9mp1PaotpXSToNCiu4GLwd6mq/authorisations/463318a0-1e33-45d8-8209-e16444b18dda"));
        expectedLinks.setAuthoriseTransaction(new Xs2aHrefType("http://url/v2/consents/confirmation-of-funds/9mp1PaotpXSToNCiu4GLwd6mq/authorisations/463318a0-1e33-45d8-8209-e16444b18dda"));
        assertEquals(expectedLinks, links);
    }
    ...
    void isScaStatusMethodIdentified() {
        ...
        expectedLinks.setScaStatus(new Xs2aHrefType("http://url/v2/consents/confirmation-of-funds/9mp1PaotpXSToNCiu4GLwd6mq/authorisations/463318a0-1e33-45d8-8209-e16444b18dda"));
        expectedLinks.setUpdatePsuAuthentication(new Xs2aHrefType("http://url/v2/consents/confirmation-of-funds/9mp1PaotpXSToNCiu4GLwd6mq/authorisations/463318a0-1e33-45d8-8209-e16444b18dda"));
        assertEquals(expectedLinks, links);
    }

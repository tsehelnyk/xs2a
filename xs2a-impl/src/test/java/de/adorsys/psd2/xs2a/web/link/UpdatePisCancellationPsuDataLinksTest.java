...
class UpdatePisCancellationPsuDataLinksTest {
    ...
    void isScaStatusMethodAuthenticated() {
        links = new UpdatePisCancellationPsuDataLinks(HTTP_URL, scaApproachResolver, request, Xs2aScaStatus.PSUAUTHENTICATED, authenticationObject);
        ...
        expectedLinks.setSelectAuthenticationMethod(new Xs2aHrefType("http://url/v1/payments/sepa-credit-transfers/1111111111111/cancellation-authorisations/463318a0-1e33-45d8-8209-e16444b18dda"));
        assertEquals(expectedLinks, links);
    }

    @Test
    void isScaStatusMethodIdentified() {
        links = new UpdatePisCancellationPsuDataLinks(HTTP_URL, scaApproachResolver, request, Xs2aScaStatus.PSUIDENTIFIED, authenticationObject);
    ...
    void isAnotherScaStatus_failed() {
        links = new UpdatePisCancellationPsuDataLinks(HTTP_URL, scaApproachResolver, request, Xs2aScaStatus.FAILED, authenticationObject);
    ...
    void isScaStatusMethodSelectedAndNotDecoupled() {
        links = new UpdatePisCancellationPsuDataLinks(HTTP_URL, scaApproachResolver, request, Xs2aScaStatus.SCAMETHODSELECTED, authenticationObject);

        expectedLinks.setScaStatus(new Xs2aHrefType("http://url/v1/payments/sepa-credit-transfers/1111111111111/cancellation-authorisations/463318a0-1e33-45d8-8209-e16444b18dda"));
        expectedLinks.setAuthoriseTransaction(new Xs2aHrefType("http://url/v1/payments/sepa-credit-transfers/1111111111111/cancellation-authorisations/463318a0-1e33-45d8-8209-e16444b18dda"));
        assertEquals(expectedLinks, links);
    }
    ...
    void isScaStatusMethodNotSelectedOrDecoupled() {
        ...
        links = new UpdatePisCancellationPsuDataLinks(HTTP_URL, scaApproachResolver, request, Xs2aScaStatus.RECEIVED, authenticationObject);
    ...
    void isScaStatusFinalised() {
        links = new UpdatePisCancellationPsuDataLinks(HTTP_URL, scaApproachResolver, request, Xs2aScaStatus.FINALISED, authenticationObject);

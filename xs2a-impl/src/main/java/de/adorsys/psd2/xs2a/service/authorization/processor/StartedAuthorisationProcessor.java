...
public class StartedAuthorisationProcessor extends AuthorisationProcessor {

    public StartedAuthorisationProcessor(AuthorisationProcessorServiceProvider applicationContext) {
        super(applicationContext);
    }

    @Override
    public Xs2aScaStatus getScaStatus() {
        return Xs2aScaStatus.STARTED;
    }
    ...
    protected AuthorisationProcessorResponse execute(AuthorisationProcessorRequest request,
        ...
        return processorService.doScaStarted(request);
    }
}

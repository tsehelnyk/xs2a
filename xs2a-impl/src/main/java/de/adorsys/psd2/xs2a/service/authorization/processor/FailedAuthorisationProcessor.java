...
public class FailedAuthorisationProcessor extends AuthorisationProcessor {

    public FailedAuthorisationProcessor(AuthorisationProcessorServiceProvider applicationContext) {
        super(applicationContext);
    }

    @Override
    public Xs2aScaStatus getScaStatus() {
        return Xs2aScaStatus.FAILED;
    }
    ...
    protected AuthorisationProcessorResponse execute(AuthorisationProcessorRequest request,
        ...
        return processorService.doScaFailed(request);
    }
}
